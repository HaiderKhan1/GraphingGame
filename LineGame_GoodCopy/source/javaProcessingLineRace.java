...
public class javaProcessingLineRace extends PApplet {
...
final float SLOPE_INCREMENT = 0.5f;
...
//custom function
public void drawText(String msg, int x, int y, int siz) {
  textSize(siz);
...
public void drawCoolLine(float x1, float y1, float x2, float y2, int c) { 
...
public void drawLine(float _m, float _b, int col, boolean cool) {
  strokeWeight(5);
...
public void startScreen() {
  ...
  drawText("***LINE RACE***", width/2, (int)(height*0.25f), 80);
  drawText("Instructions", width/2, (int)(height*0.55f), 30);
  drawText("--------------------------------------------", width/2, (int)(height*0.60f), 30);
  drawText("Use arrows to move your flashing line to match the red line", width/2, (int)(height*0.65f), 30);
  drawText("UP/DOWN Arrow Keys to change the y-intercept", width/2, (int)(height*0.70f), 30);
  drawText("LEFT/RIGHT Arrow Keys to change the slope", width/2, (int)(height*0.75f), 30);
  drawText("You get 5 chances to get the best time.", width/2, (int)(height*0.80f), 30);
}

public void newBestTime(float newTime) {
  frames ++;
...
public void gameOver() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#195EB4", "--stop-color=#05342B", "javaProcessingLineRace" };
    if (passedArgs != null) {
